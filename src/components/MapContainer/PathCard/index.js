...
const PathCard = ({path}) => {
    ...
    const center = {
        lat: path.routes[0].source.location.latitude,
        lng: path.routes[0].source.location.longitude
    };
        ...
        <div className={'path-card'}>
            <div className={'path-info'}>
                ...
                <div className={'total-info'}>
                    ...
                    <span>Total duration from: <strong>{path.total_duration.min}</strong> days</span>
                    <span>Total duration to: <strong>{path.total_duration.max}</strong> days</span>
