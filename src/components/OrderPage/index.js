            ...
            <div className={'form-wrapper'}>
              <div className={'cargo-wrapper'}>
                <div className={'title-wrapper'}>
                  ...
                  <div className={'cargo-all-info'}>Элементов: {data.length} Общий вес: {weight} кг Общий объем: {volume} м³</div>
                </div>
                          ...
                          !activeContainerButton ?
                              <div className={'wrapper'}>
                                <div className={'typeof-cargo'}>
                                  ...
                                  <select name='Тип Груза' id={'typeof-cargo'} value={item.cargo} onChange={(e)=>updateItem('cargo', e.target.value)}>
                                  ...
                                  <div className={'sizeof-cargo-input'}>
                                    {
                                      item.cargo === 'Коробки' ?
                                          <>
                                            ...
                                            <div className={'sizeof-cargo-wrapper'}>
                                              ...
                                              <input
                                                  ...
                                                  step={1}
                                                  placeholder={'Высота'}/>
                                              <select name="CM" id="sizeof-cargo" value={item.size} onChange={(e)=>updateItem('size', e.target.value)}>
                                          ...
                                          <div className={'sizeof-pallet-wrapper'}>
                                            ...
                                            <select name={'sizeof-pallet'} id={'sizeof-pallet'} value={item.sizePallet} onChange={(e)=>updateItem('sizePallet', e.target.value)}>
                                ...
                                <div className={'weight-cargo'}>
                                  ...
                                  <div className={'weight-cargo-input'}>
                                    ...
                                    <select name="weight-cargo" value={item.weight}  onChange={(e)=>updateItem('weight', e.target.value)} id="weight-cargo">
                                      <option value="KG">KG</option>
                                    </select>
                                  </div>
                                </div>
                                <img src={trash} alt={'trash'} className={'trash-icon'}  onClick={() => deleteItem(index)}/>
                              </div>
                              :
                                ...
                                <div className={'container-buttons'}>
                                  ...
                                  <div className={'container-buttons-wrapper'}>
                                    <div
                                        ...
                                        className={firstContainerButton ? 'active-first-button' : 'first-button'}>20'</div>
                                    <div
                                        onClick={SecondContainerActiveButtonHandler}
                                        className={secondContainerButton ? 'active-second-button' : 'second-button'}>40'</div>
                                    <div
                                        onClick={ThirdContainerActiveButtonHandler}
                                        className={thirdContainerButton ? 'active-third-button' : 'third-button'}>40'HC</div>
                                  </div>
                                </div>
