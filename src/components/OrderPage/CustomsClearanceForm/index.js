       ...
       <div className={'description-wrapper'}>
         {
           showInfo ?
             <div className={'description'}>
               <div>Услуги по таможенному оформлению и предоставление электронно-цифровой подписи (ЭЦП) Таможенного представителя:</div>
               ...
               <div>До 4 товарных позиций (без учета таможенных платежей и сборов), каждый дополнительный лист к ДТ – 1250 руб, вкл. НДС.</div>
             </div>
             :
             ""
         }
